 ...
 * Optimized for serverless/Render deployment with @sparticuz/chromium
 */
...
// Enhanced stealth args combining chromium defaults with anti-detection
const STEALTH_ARGS = [
    ...chromium.args,
...
async function searchAA(query) {
    ...
    try {
      ...
      // Longer wait for page to fully load and session cookies
